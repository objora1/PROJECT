...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.img_add = tk.PhotoImage(file="C:\\PY\\PROJECT\\image\\add.png")
        ...
        self.img_upd = tk.PhotoImage(file="C:\\PY\\PROJECT\\image\\change.png")
        ...
        # Кнопка поиска
        self.img_search = tk.PhotoImage(file="C:\\PY\\PROJECT\\image\\search.png")
        ...
        # Кнопка обновления
        self.img_refresh = tk.PhotoImage(file="C:\\PY\\PROJECT\\image\\refresh.png")
